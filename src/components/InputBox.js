...
function InputBox(props) {
  ...
  const getTextStyle = () => {
    try {
      ...
      let textStyle = {
        color: disabled ? theme.color.placeholder : theme.color.secondPrimary,
  ...
  const outlineColor = '#C0C0C0';
  const activeOutlineColor = theme.color.secondPrimary;
  const dropdownData = () => {
    if (showYearPicker) {
    ...
    <>
      ...
      {!isDropdown && !showYearPicker && (
        <TextInput
          ...
          theme={{
            colors: {
              primary: theme.color.secondPrimary,
      ...
      {elRefs.map((ele, i) => (
        <RNInput
          ...
          style={[
            ...
            isFocus && {
              borderColor: theme.color.secondPrimary,
            },
            inputStyle,
            size && {
              width: size,
